...
<head>
	...
	<title>Skyring Source: node_modules/keef/index.js</title>
...
<div class="row">
	...
	<div class="col-md-12">
		...
		<h1 class="page-title">Source: node_modules/keef/index.js</h1>
    
<section>
    <article>
        <pre
            class="sunlight-highlight-javascript ">/*jshint node:true, laxcomma: true, smarttabs: true*/
'use strict'
/**
...
for (const pconf of apppaths) {
  try {
    const config = require( path.join( pconf, 'conf' ) )
...
function toArray(item) {
  ...
  return typeof item === 'string' ? item.split(csv_exp) : [item]
}
